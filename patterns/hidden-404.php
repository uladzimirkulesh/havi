...
<div class="wp-block-group error404-container">
	...
	<p class="has-text-align-center has-contrast-2-color has-text-color" style="margin-top:var(--wp--preset--spacing--10)"><?php echo esc_html_x( 'The page you are looking for cannot be found.', 'Message to convey that a webpage could not be found', 'havi' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-button">
			<a class="wp-block-button__link wp-element-button" href="http://localhost:8888/wordpress/" rel="home"><?php esc_html_e( 'Back to Home', 'havi' ); ?></a>
		</div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
