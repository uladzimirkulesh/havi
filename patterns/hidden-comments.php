...
<section class="wp-block-comments is-layout-constrained has-global-padding" style="margin-top:var(--wp--preset--spacing--60)">
	...
	<!-- wp:comment-template -->
		<!-- wp:group {"tagName":"article","style":{"border":{"top":{"color":"var:preset|color|contrast-6","width":"1px"}},"spacing":{"padding":{"top":"var:preset|spacing|30"},"margin":{"bottom":"var:preset|spacing|30"}}},"className":"comment-body","layout":{"type":"default"}} -->
		<article class="wp-block-group comment-body" style="border-top-color:var(--wp--preset--color--contrast-6);border-top-width:1px;margin-bottom:var(--wp--preset--spacing--30);padding-top:var(--wp--preset--spacing--30)">
