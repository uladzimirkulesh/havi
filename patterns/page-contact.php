	...
	<div class="wp-block-group contact-info">
		...
		<div class="wp-block-group contact-block" style="padding-bottom:var(--wp--preset--spacing--10)">
			...
			<div class="wp-block-group contact-block__item" style="border-top-color:var(--wp--preset--color--contrast-4);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)">
				...
				<p style="margin-top:var(--wp--preset--spacing--10)"><?php echo wp_kses_post( _x( '<a href="mailto:#">hello@davegearhart.com</a>', 'Contact page pattern contacts block text', 'havi' ) ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}}} -->
				<p style="margin-top:0"><?php echo wp_kses_post( _x( '<a href="tel:#">+44 209 555 014</a>', 'Contact page pattern contacts block text', 'havi' ) ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group contact-block__item" style="border-top-color:var(--wp--preset--color--contrast-4);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)">
				...
				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|10"}}}} -->
				<p style="margin-top:var(--wp--preset--spacing--10)"><?php echo wp_kses_post( _x( '2118 Thornridge Cir. Syracuse,<br>Connecticut 35624', 'Contact page pattern adress block text', 'havi' ) ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group contact-block__item" style="border-top-color:var(--wp--preset--color--contrast-4);border-top-style:solid;border-top-width:1px;padding-top:var(--wp--preset--spacing--30)">
				...
				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|10"}}}} -->
				<p style="margin-top:var(--wp--preset--spacing--10)"><?php echo wp_kses_post( _x( '<a href="#" target="_blank" rel="noreferrer noopener">Instagram</a>', 'Contact page pattern socials block link', 'havi' ) ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}}} -->
				<p style="margin-top:0"><?php echo wp_kses_post( _x( '<a href="#" target="_blank" rel="noreferrer noopener">Telegram</a>', 'Contact page pattern socials block link', 'havi' ) ); ?></p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0"}}}} -->
				<p style="margin-top:0"><?php echo wp_kses_post( _x( '<a href="#" target="_blank" rel="noreferrer noopener">GitHub</a>', 'Contact page pattern socials block link', 'havi' ) ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
