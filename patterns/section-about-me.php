...
<section class="wp-block-group alignwide section section--about-me" id="section-about-me" style="margin-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group section__header grid">
		<!-- wp:heading {"level":1} -->
		<h1 class="wp-block-heading"><?php echo esc_html_x( 'Armed with my knowledge of product and brand, I am adept at problem-solving, storytelling, and delivering immersive experiences.', 'About me section title', 'havi' ); ?></h1>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group section__content grid">
		<!-- wp:paragraph -->
		<p><?php echo esc_html_x( 'I am Dhavid Gearhart, a Digital Designer based in New York, USA. I\'ve been in the industry for 10+ years, creating designs for both digital and print projects for clients such as Sony, Mitsubishi, General Electric, and Louis Vuitton. Currently working at IBM as a Digital Art Director.', 'About me section text', 'havi' ); ?></p>
		<!-- /wp:paragraph -->
