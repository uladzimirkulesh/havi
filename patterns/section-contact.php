...
<section class="wp-block-group alignwide section section--contact" id="section-contact">
	...
	<div class="wp-block-group section__content grid">
		...
		<p class="has-xxxx-large-font-size"><?php echo esc_html_x( 'Have a project in mind? Or you want to say hello, get in touch with me.', 'Contact section text', 'havi' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:buttons -->
		<div class="wp-block-buttons">
			<!-- wp:button -->
			<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/contact/"><?php echo esc_html_x( 'Contact Me', 'Contact section button text', 'havi' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
