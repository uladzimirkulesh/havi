...
<section class="wp-block-group alignfull section section--hero has-global-padding-top is-style-has-global-padding" id="section-hero" style="padding-bottom:var(--wp--preset--spacing--30)">
	...
	<div class="wp-block-group alignwide section__content">
		...
		<div class="wp-block-group wrapper grid">
			...
			<h1 class="wp-block-heading hero-title has-xxxxxxx-large-font-size" style="line-height:0.9"><?php echo wp_kses_post( _x( 'Digital<br>Designer', 'Hero section title', 'havi' ) ); ?></h1>
			<!-- /wp:heading -->
			...
			<div class="wp-block-group hero-subtitle" style="margin-top:0">
				...
				<p class="has-large-font-size"><?php echo esc_html_x( 'Skilled in Web Design, UX/UI, Webflow and Front End Development.', 'Hero section subtitle', 'havi' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
