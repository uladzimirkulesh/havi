...
<section class="wp-block-group alignwide section section--process" id="section-process" style="margin-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group section__header">
		...
		<h2 class="wp-block-heading has-xxxxx-large-font-size"><?php echo esc_html_x( 'Working Process', 'Process section title', 'havi' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group section__content grid">
		<!-- wp:group {"metadata":{"name":"Process Item"},"style":{"spacing":{"padding":{"left":"var:preset|spacing|30"}},"border":{"left":{"color":"var:preset|color|contrast-6","style":"solid","width":"1px"}}},"className":"process__item","layout":{"type":"default"}} -->
		<div class="wp-block-group process__item" style="border-left-color:var(--wp--preset--color--contrast-6);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--30)">
			<!-- wp:heading {"level":3} -->
			...
			<p style="margin-top:var(--wp--preset--spacing--30)"><?php echo esc_html_x( 'By identifying and embracing your brand\'s core values, we will create an authentic and consistent brand image that will resonate with consumers and set you apart from competitors. Let these values guide your organization to success.', 'Process section item text', 'havi' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group process__item" style="border-left-color:var(--wp--preset--color--contrast-6);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--30)">
			...
			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|30"}}}} -->
			<p style="margin-top:var(--wp--preset--spacing--30)"><?php echo esc_html_x( 'This is the phase were we craft a launch communication plan that outlines key messages and personalizes them for the specific audience. Keeping the future of the brand in mind by following brand guidelines.', 'Process section item text', 'havi' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
