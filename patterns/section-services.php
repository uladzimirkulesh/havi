...
<section class="wp-block-group alignwide section section--services" id="section-services" style="margin-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group section__content grid">
		<!-- wp:group {"metadata":{"name":"Services item"},"style":{"border":{"left":{"color":"var:preset|color|contrast-6","style":"solid","width":"1px"}},"spacing":{"padding":{"left":"var:preset|spacing|30"}}},"className":"services__item","layout":{"type":"default"}} -->
		<div class="wp-block-group services__item" style="border-left-color:var(--wp--preset--color--contrast-6);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--30)">
			<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-5"}}},"typography":{"lineHeight":"1"}},"textColor":"contrast-5","fontSize":"xxxxx-large"} -->
			<p class="has-contrast-5-color has-text-color has-link-color has-xxxxx-large-font-size" style="line-height:1"><?php echo esc_html_x( '01', 'Services section item number', 'havi' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group services__item" style="border-left-color:var(--wp--preset--color--contrast-6);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--30)">
			<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-5"}}},"typography":{"lineHeight":"1"}},"textColor":"contrast-5","fontSize":"xxxxx-large"} -->
			<p class="has-contrast-5-color has-text-color has-link-color has-xxxxx-large-font-size" style="line-height:1"><?php echo esc_html_x( '02', 'Services section item number', 'havi' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group services__item" style="border-left-color:var(--wp--preset--color--contrast-6);border-left-style:solid;border-left-width:1px;padding-left:var(--wp--preset--spacing--30)">
			<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-5"}}},"typography":{"lineHeight":"1"}},"textColor":"contrast-5","fontSize":"xxxxx-large"} -->
			<p class="has-contrast-5-color has-text-color has-link-color has-xxxxx-large-font-size" style="line-height:1"><?php echo esc_html_x( '03', 'Services section item number', 'havi' ); ?></p>
			<!-- /wp:paragraph -->
